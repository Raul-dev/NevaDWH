...
В этом проекте предствален результат генерации DWH из xml метаданных 1С, которые можно получить запустив 1cv8.exe /DumpConfigToFiles. Так же в качестве метаданных может быть использован формат json из адаптера компании 1Bit https://spb.1cbit.ru/ или любой другой при небольшой доработке.
