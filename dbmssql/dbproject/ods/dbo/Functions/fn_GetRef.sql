...
BEGIN
	...
	--RETURN CAST(@var.value('declare default element namespace "http://v8.1c.ru/8.1/data/enterprise/current-config"; (/Data/Реквизиты/DocumentObject.Продажи/Ref/text())[1]', 'varchar(36)') AS uniqueidentifier )
END;