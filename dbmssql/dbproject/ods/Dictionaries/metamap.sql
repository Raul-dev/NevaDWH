...
VALUES
(1, 'Unknown', 'msgqueue', 5, CAST(N'https://nevadwh.ru/CatalogObject.Unknown' AS varchar(255)), CAST('https://nevadwh.ru/CatalogObject.Unknown/version1' AS varchar(255)), NULL, NULL, 1),
...
IF EXISTS ( 
    ...
    WHERE s.[metamap_id] IS NULL) THROW 60000, N'Таблица роутов сообщений [dbo].[metamap] была вручную изменена в базе данных ', 1;
