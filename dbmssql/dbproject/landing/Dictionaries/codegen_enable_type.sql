...
(0, N'Исключить из проекта'),
(1, N'Генерировать код если файлы отсутствуют'), --First Generation
(2, N'Генерировать только таблицы всегда , процедуры только если отсутствуют'),
(3, N'Генерировать код ')
