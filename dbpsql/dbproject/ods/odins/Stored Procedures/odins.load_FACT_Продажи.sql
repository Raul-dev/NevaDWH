...
BEGIN
  ...
  BEGIN
    ...
    SELECT
      ...
      CAST((xpath('/nva:Data/nva:Реквизиты/nva:DocumentObject.Продажи/nva:DateID/text()', msg::xml, var_xmlns ))[1]::text as integer)  AS "DateID",
      ...
      CAST((xpath('/nva:Data/nva:Реквизиты/nva:DocumentObject.Продажи/nva:ДатаОтгрузкиID/text()', msg::xml, var_xmlns ))[1]::text as integer)  AS "ДатаОтгрузкиID",
