...
UNION SELECT 3,  2,  'DIM_Клиенты',  true,  true ,  'DIM_Клиенты',  false,  false,  false
UNION SELECT 4,  3,  'DIM_Товары',  true,  true ,  'DIM_Товары',  false,  false,  false
...
UNION SELECT 30,  5,  'DateID',  'integer',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 31,  5,  'ДатаОтгрузки',  'timestamp',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 32,  5,  'ДатаОтгрузкиID',  'integer',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 33,  5,  'Клиент',  'varchar',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 34,  5,  'ТипДоставки',  'varchar',  '500',  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 35,  5,  'ПримерСоставногоТипа',  'varchar',  '36',  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 36,  5,  'ПримерСоставногоТипа_ТипЗначения',  'varchar',  '128',  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 37,  6,  'FACT_ПродажиRefID',  'uuid',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 38,  6,  'Доставка',  'boolean',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 39,  6,  'Товар',  'varchar',  NULL,  NULL,  NULL,  true,  false,  true,  NULL
UNION SELECT 40,  6,  'Колличество',  'decimal',  NULL,  '12',  '0',  true,  false,  true,  NULL
UNION SELECT 41,  6,  'Цена',  'decimal',  NULL,  '16',  '4',  true,  false,  true,  NULL
;
...
VALUES
(9001, 'Unknown', 'mq.msgqueue', 5,CAST('https://nevadwh.ru/CatalogObject.Unknown' AS varchar(255)), CAST('https://nevadwh.ru/CatalogObject.Unknown/version1' AS varchar(255)), NULL, NULL, true),
(1, N'CatalogObject.Валюты', N'odins."DIM_Валюты_buffer"', 1, N'https://nevadwh.ru/CatalogObject.Валюты', N'https://nevadwh.ru/CatalogObject.Валюты/version1', 'odins."load_DIM_Валюты"', N'odins.[load_DIM_Валюты_file]', true),
(2, N'CatalogObject.Клиенты', N'odins."DIM_Клиенты_buffer"', 1, N'https://nevadwh.ru/CatalogObject.Клиенты', N'https://nevadwh.ru/CatalogObject.Клиенты/version1', 'odins."load_DIM_Клиенты"', N'odins.[load_DIM_Клиенты_file]', true),
(3, N'CatalogObject.Товары', N'odins."DIM_Товары_buffer"', 1, N'https://nevadwh.ru/CatalogObject.Товары', N'https://nevadwh.ru/CatalogObject.Товары/version1', 'odins."load_DIM_Товары"', N'odins.[load_DIM_Товары_file]', true),
(4, N'DocumentObject.Продажи', N'odins."FACT_Продажи_buffer"', 1, N'https://nevadwh.ru/DocumentObject.Продажи', N'https://nevadwh.ru/DocumentObject.Продажи/version1', 'odins."load_FACT_Продажи"', N'odins.[load_FACT_Продажи_file]', true),
(9002, 'Справочник.адаптер_СхемыДанных', 'mq.metadata_buffer', 4, 'https://nevadwh.ru/Справочник.адаптер_СхемыДанных', 'https://nevadwh.ru/Справочник.адаптер_СхемыДанных/version1', 'mq.load_metadata', NULL, true),
(9003, 'CatalogObject.NevaDWH_Метаданные', 'mq.metadata_buffer', 1, 'https://nevadwh.ru/CatalogObject.NevaDWH_Метаданные', 'https://nevadwh.ru/CatalogObject.NevaDWH_Метаданные/version1', 'mq.load_metadata', NULL, true),
(9004, 'Unknown', 'mq.msgqueue', 1, 'https://nevadwh.ru/CatalogObject.Unknown', 'https://nevacgate.ru/CatalogObject.Unknown/version1', NULL, NULL, true),
(9005, 'Unknown', 'mq.msgqueue', 2, 'https://nevadwh.ru/CatalogObject.Unknown', 'https://nevacgate.ru/CatalogObject.Unknown/version1', NULL, NULL, true),
(9006, 'Unknown', 'mq.msgqueue', 3, 'https://nevadwh.ru/CatalogObject.Unknown', 'https://nevacgate.ru/CatalogObject.Unknown/version1', NULL, NULL, true),
(9007, 'Unknown', 'mq.msgqueue', 4, 'https://nevadwh.ru/CatalogObject.Unknown', 'https://nevacgate.ru/CatalogObject.Unknown/version1', NULL, NULL, true)
;
UPDATE mq.metamap m
SET 
  msg_key = src.msg_key,
