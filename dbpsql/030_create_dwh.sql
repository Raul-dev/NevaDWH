...
BEGIN
  ...
  FROM staging."DIM_Валюты" as src
    LEFT JOIN target."DIM_Валюты" as trget ON trget.end_date = mq."fn_GetMaxDate"() AND trget.nkey = src.nkey AND trget.vkey = src.vkey
  ...
  FROM (
    SELECT source.*
      ...
      WHERE source.end_date = mq."fn_GetMaxDate"() AND
...
BEGIN
  ...
  FROM staging."DIM_Клиенты" as src
    LEFT JOIN target."DIM_Клиенты" as trget ON trget.end_date = mq."fn_GetMaxDate"() AND trget.nkey = src.nkey AND trget.vkey = src.vkey
  WHERE staging.staging_id = src.staging_id;
...
BEGIN
  ...
  FROM staging."DIM_Товары" as src
    LEFT JOIN target."DIM_Товары" as trget ON trget.end_date = mq."fn_GetMaxDate"() AND trget.nkey = src.nkey AND trget.vkey = src.vkey
  WHERE staging.staging_id = src.staging_id;
...
BEGIN
  ...
  FROM staging."FACT_Продажи" as src
    LEFT JOIN target."FACT_Продажи" as trget ON trget.end_date = mq."fn_GetMaxDate"() AND trget.nkey = src.nkey AND trget.vkey = src.vkey
  WHERE staging.staging_id = src.staging_id;
